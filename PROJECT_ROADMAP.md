...
- **M-T1.2: Synthetic Dataset Gold** - Generazione locale massiva con Gain-Scaling randomizzato.

### FASE 2: NEURAL RESEARCH
- **M-T2.1: Brain Training** - Addestramento Multi-Scale TCN.
- **M-T2.2: Benchmarking** - Verifica accuratezza su dataset di test reale (non sintetico).
...
- **M-T4.2: Final Delivery** - Packaging VST3/AU/AAX.
