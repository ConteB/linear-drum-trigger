...
Documenti indicizzati: **55** · senza frontmatter: **28**.
...
| `LIN-DT-CHRONOS-001` | Chronos Engine — MIDI Timing Specifications | spec | LOCKED | F4 | `04_INTELLIGENCE/MIDI_CHRONOS_SPEC.md` |
| `LIN-DT-COMPAN-001` | Analisi della Concorrenza — OP-NeuroTrigger | reference | ACTIVE | cross-cutting | `04_INTELLIGENCE/COMPETITOR_ANALYSIS.md` |
| `LIN-DT-DCBP-001` | Dataset Card Blueprint (addendum) | spec | LOCKED | F0 | `04_INTELLIGENCE/DATASET_CARD_BLUEPRINT.md` |
| `LIN-DT-DESIGN-001` | Linear Design Guide — OP-NeuroTrigger | standard | LOCKED | F4 | `04_INTELLIGENCE/UX_UI/LINEAR_DESIGN_GUIDE.md` |
| `LIN-DT-DIARY-001` | Diario di Presidenza — Drum-Trigger | registro | ACTIVE | cross-cutting | `04_INTELLIGENCE/Diario_Presidenza_OpenPhase.md` |
| `LIN-DT-DOCSTD-001` | OP-NEUROTRIGGER Doc Standard — Documentation Linking Layer | standard | LOCKED | cross-cutting | `04_INTELLIGENCE/DOC_LINKING_STANDARD.md` |
...
| `LIN-DT-MKTSTRAT-001` | Strategia di Marketing & Posizionamento (Lean-Guerrilla) | reference | ACTIVE | cross-cutting | `04_INTELLIGENCE/MARKETING_STRATEGY.md` |
...
| `LIN-DT-REGAV-001` | Registro Avanzamento Commessa — Drum-Trigger | registro | ACTIVE | cross-cutting | `04_INTELLIGENCE/REGISTRO_AVANZAMENTO.md` |
| `LIN-DT-ROADMAP-001` | Project Roadmap (ARCHIVIATO — era OP-X) | reference | ARCHIVED | cross-cutting | `PROJECT_ROADMAP.md` |
...
| `LIN-DT-RUNBOOK-AZURE-ENABLEMENT` | Azure Support — SKU Enablement NCADSA100v4 + Quota Standard_D16s_v3 | runbook | ACTIVE | F2 | `docs/runbooks/F2-T1_AZURE_SUPPORT_ENABLEMENT.md` |
...
| `LIN-DT-RUNBOOK-F2T1-SMOKE` | F2-T1 — Smoke test VM render Azure (15 min, ~$0.03 spot) | runbook | ACTIVE | F2 | `docs/runbooks/F2-T1_SMOKE_NOW.md` |
...
| `LIN-DT-SPEC-F0T4D` | F0-T4d — Preprocessing Harness + Training Audit (STRP-001) | spec | LOCKED | F0 | `docs/methodology/F0-T4d_PREPROCESSING_HARNESS_AND_AUDIT_SPEC.md` |
...
| `LIN-DT-UXBP-001` | UX Blueprint STRP-001 — Incertezza AI & UI Layout | spec | ACTIVE | F4 | `04_INTELLIGENCE/UX_UI/UX_BLUEPRINT_STRP-001.md` |

## Indice per tag

- **F0** — `LIN-DT-BLUEPRINT-001`, `LIN-DT-HANDOVER-001`
- **F0-T1** — `LIN-DT-LICVER-F0T1`
- **F0-T15** — `LIN-DT-AUGAUDIT-001`
- **F0-T15-post** — `LIN-DT-SPEC-F0T15POST`
- **F0-T15-pre** — `LIN-DT-SPEC-F0T15PRE`
- **F0-T17** — `LIN-DT-SPEC-F0T17`
- **F0-T1b** — `LIN-DT-ROSTER-F0T1b`
- **F0-T1c** — `LIN-DT-HOLDOUT-F0T1c`
- **F0-T2a** — `LIN-DT-SPEC-F0T2a`
- **F0-T4a** — `LIN-DT-SPEC-F0T4C`, `LIN-DT-SPEC-F0T4a`
- **F0-T4c** — `LIN-DT-SPEC-F0T4C`
- **F0-T4d** — `LIN-DT-SPEC-F0T4D`
- **F0-T5** — `LIN-DT-SPEC-F0T5`
- **F0-T8** — `LIN-DT-SPEC-F0T8`
- **F1** — `LIN-DT-RUNBOOK-F1T1`
- **F2-T1** — `LIN-DT-RUNBOOK-F2T1`, `LIN-DT-RUNBOOK-F2T1QUOTA`
- **P1-pre-emphasis** — `LIN-DT-SPEC-F0T4D`
- **P2-onset-envelope** — `LIN-DT-SPEC-F0T4D`
- **STRP-001** — `LIN-DT-SPEC-F0T15POST`, `LIN-DT-SPEC-F0T15PRE`, `LIN-DT-SPEC-F0T4C`, `LIN-DT-SPEC-F0T4D`
- **addendum** — `LIN-DT-DCBP-001`
- **aes-gcm** — `LIN-DT-SPEC-F0T8`
- **ai** — `LIN-DT-DCBP-001`, `LIN-DT-RPTBP-001`
- **arbitrage** — `LIN-DT-SCHED-001`
- **architecture** — `LIN-DT-DOSSIER-001`
- **archived** — `LIN-DT-PMINDEX-001`, `LIN-DT-REC-001`, `LIN-DT-ROADMAP-001`, `LIN-DT-SPRINT-001`
- **audio** — `LIN-DT-SPEC-F0T15POST`
- **audit** — `LIN-DT-AUDIT-001`, `LIN-DT-AUGAUDIT-001`
- **augmentation** — `LIN-DT-AUGAUDIT-001`, `LIN-DT-DOSSIER-001`, `LIN-DT-SPEC-F0T15POST`, `LIN-DT-SPEC-F0T15PRE`
- **azure** — `LIN-DT-RUNBOOK-AZURE-ENABLEMENT`, `LIN-DT-RUNBOOK-F1T1`, `LIN-DT-RUNBOOK-F2T1`, `LIN-DT-RUNBOOK-F2T1-SMOKE`, `LIN-DT-RUNBOOK-F2T1QUOTA`, `LIN-DT-SIA-001`
- **backlog** — `LIN-DT-AUGAUDIT-001`
- **binarydata** — `LIN-DT-SPEC-F0T8`
...
- **ceo-action** — `LIN-DT-RUNBOOK-F1T1`, `LIN-DT-RUNBOOK-F2T1`, `LIN-DT-RUNBOOK-F2T1QUOTA`
- **checklist** — `LIN-DT-CHKLST-001`
- **chronos** — `LIN-DT-CHRONOS-001`
- **coding-standards** — `LIN-DT-ENGSTD-001`
- **competitor** — `LIN-DT-COMPAN-001`, `LIN-DT-TCAUDIT-001`
- **compliance** — `LIN-DT-DPL-001`, `LIN-DT-HOLDOUT-F0T1c`, `LIN-DT-LICVER-F0T1`, `LIN-DT-ROSTER-F0T1b`
- **consistency** — `LIN-DT-AUDIT-001`
- **data-audit** — `LIN-DT-SPEC-F0T17`
- **data-contract** — `LIN-DT-SPEC-F0T2a`
- **dataset** — `LIN-DT-AUGAUDIT-001`, `LIN-DT-DCBP-001`
- **decisions** — `LIN-DT-DIARY-001`
- **demo** — `LIN-DT-MKTOCULAR-001`
- **dependencies** — `LIN-DT-ENGSTD-001`
- **design** — `LIN-DT-DESIGN-001`
- **design-lock** — `LIN-DT-CHKLST-001`
- **determinism** — `LIN-DT-ENGSTD-001`
- **doctrine** — `LIN-DT-SCHED-001`, `LIN-DT-TESTDOC-001`
...
- **f2-t1** — `LIN-DT-RUNBOOK-AZURE-ENABLEMENT`, `LIN-DT-RUNBOOK-F2T1-SMOKE`
...
- **gpu** — `LIN-DT-RUNBOOK-AZURE-ENABLEMENT`
- **handover** — `LIN-DT-HANDOVER-001`
- **holdout** — `LIN-DT-HOLDOUT-F0T1c`
- **index** — `LIN-DT-PMINDEX-001`
- **infrastructure** — `LIN-DT-RUNBOOK-F1T1`, `LIN-DT-SIA-001`
- **input-agnostic** — `LIN-DT-AUGAUDIT-001`, `LIN-DT-SPEC-F0T15POST`
- **italynorth** — `LIN-DT-RUNBOOK-F2T1QUOTA`
- **juce** — `LIN-DT-SPEC-F0T8`
- **kit-roster** — `LIN-DT-ROSTER-F0T1b`
- **ledger** — `LIN-DT-SPEC-F0T4D`
- **legal** — `LIN-DT-DPL-001`, `LIN-DT-PII-001`
- **licensing** — `LIN-DT-DPL-001`, `LIN-DT-LICVER-F0T1`
- **linear-shield** — `LIN-DT-GOV-001`
- **logging** — `LIN-DT-PII-001`
- **lookahead** — `LIN-DT-SPEC-F0T4C`
- **loss-imbalance** — `LIN-DT-SPEC-F0T4C`
...
- **midi** — `LIN-DT-CHRONOS-001`, `LIN-DT-SPEC-F0T15PRE`
- **milestones** — `LIN-DT-REGAV-001`
- **mir_eval** — `LIN-DT-SPEC-F0T17`
- **model-artifact** — `LIN-DT-SPEC-F0T8`
- **mutation-testing** — `LIN-DT-TESTDOC-001`
- **neural** — `LIN-DT-DOSSIER-001`, `LIN-DT-SPEC-F0T4a`
- **ocular-proof** — `LIN-DT-MKTOCULAR-001`
- **onboarding** — `LIN-DT-ONBOARD-001`
- **operations** — `LIN-DT-ONBOARD-001`
- **pdc** — `LIN-DT-CHRONOS-001`
- **pii** — `LIN-DT-PII-001`
- **pointer** — `LIN-DT-PMINDEX-001`, `LIN-DT-REC-001`, `LIN-DT-ROADMAP-001`, `LIN-DT-SPRINT-001`
- **positioning** — `LIN-DT-MKTSTRAT-001`
- **post-render** — `LIN-DT-SPEC-F0T15POST`
- **pre-Azure-gate** — `LIN-DT-SPEC-F0T4C`
- **pre-render** — `LIN-DT-SPEC-F0T15PRE`
- **preprocessing** — `LIN-DT-SPEC-F0T4D`
- **privacy** — `LIN-DT-PII-001`
- **provenance** — `LIN-DT-DPL-001`
- **qa** — `LIN-DT-TESTDOC-001`
- **quota** — `LIN-DT-RUNBOOK-AZURE-ENABLEMENT`, `LIN-DT-RUNBOOK-F2T1QUOTA`
- **receptive-field** — `LIN-DT-SPEC-F0T4C`
- **recipe** — `LIN-DT-SPEC-F0T2a`
...
- **render** — `LIN-DT-RUNBOOK-F2T1`, `LIN-DT-RUNBOOK-F2T1-SMOKE`
- **reporting** — `LIN-DT-DCBP-001`, `LIN-DT-RPTBP-001`
- **roadmap** — `LIN-DT-ROADMAP-001`
- **rtneural** — `LIN-DT-SPEC-F0T8`
- **scheduling** — `LIN-DT-MSCHED-001`, `LIN-DT-SCHED-001`
- **setup** — `LIN-DT-RUNBOOK-F1T1`
- **sharding** — `LIN-DT-SPEC-F0T5`
- **smoke** — `LIN-DT-RUNBOOK-F2T1-SMOKE`
- **soft-drm** — `LIN-DT-SPEC-F0T8`
- **sprint** — `LIN-DT-SPRINT-001`
- **standard** — `LIN-DT-DESIGN-001`, `LIN-DT-DOCSTD-001`, `LIN-DT-PII-001`
- **statistics** — `LIN-DT-SPEC-F0T17`
- **strategy** — `LIN-DT-COMPAN-001`, `LIN-DT-MKTSTRAT-001`, `LIN-DT-SIA-001`, `LIN-DT-TCAUDIT-001`
- **strp-001** — `LIN-DT-UXBP-001`
- **sub-agents** — `LIN-DT-GOV-001`
- **support** — `LIN-DT-RUNBOOK-AZURE-ENABLEMENT`
- **swot** — `LIN-DT-TCAUDIT-001`
- **tcn** — `LIN-DT-SPEC-F0T4a`
- **testing** — `LIN-DT-GOV-001`, `LIN-DT-TESTDOC-001`
- **timing** — `LIN-DT-CHRONOS-001`
- **tooling** — `LIN-DT-DOCSTD-001`
- **topology** — `LIN-DT-SPEC-F0T4a`
- **tracking** — `LIN-DT-MSCHED-001`, `LIN-DT-REGAV-001`
- **training** — `LIN-DT-RPTBP-001`
- **training-audit** — `LIN-DT-SPEC-F0T4D`
...
- **vm-spot** — `LIN-DT-RUNBOOK-F2T1-SMOKE`
...
| `LIN-DT-CHRONOS-001` | `LIN-DT-DOSSIER-001`, `LIN-DT-SPEC-F0T4a` | — |
| `LIN-DT-COMPAN-001` | `LIN-DT-TCAUDIT-001`, `LIN-DT-QMA-001`, `LIN-DT-MKTSTRAT-001` | `LIN-DT-MKTSTRAT-001`, `LIN-DT-QMA-001`, `LIN-DT-TCAUDIT-001` |
| `LIN-DT-DCBP-001` | `LIN-DT-RPTBP-001`, `LIN-DT-ENGSTD-001`, `LIN-DT-DOSSIER-001` | `LIN-DT-RPTBP-001` |
...
| `LIN-DT-HANDOVER-001` | `LIN-DT-MSCHED-001`, `LIN-DT-REGAV-001` | — |
| `LIN-DT-HOLDOUT-F0T1c` | `LIN-DT-DPL-001`, `LIN-DT-DOSSIER-001`, `LIN-DT-CHKLST-001` | `LIN-DT-DPL-001` |
...
| `LIN-DT-REGAV-001` | `LIN-DT-MSCHED-001`, `LIN-DT-DIARY-001` | `LIN-DT-DIARY-001`, `LIN-DT-HANDOVER-001`, `LIN-DT-REC-001` |
...
| `LIN-DT-RPTBP-001` | `LIN-DT-DCBP-001`, `LIN-DT-ENGSTD-001`, `LIN-DT-MSCHED-001` | `LIN-DT-DCBP-001`, `LIN-DT-SPEC-F0T4D` |
| `LIN-DT-RUNBOOK-AZURE-ENABLEMENT` | `LIN-DT-MSCHED-001` | — |
| `LIN-DT-RUNBOOK-F1T1` | `LIN-DT-MSCHED-001`, `LIN-DT-INFRA-001` | `LIN-DT-RUNBOOK-F2T1` |
| `LIN-DT-RUNBOOK-F2T1` | `LIN-DT-MSCHED-001`, `LIN-DT-SIA-001`, `LIN-DT-RUNBOOK-F1T1`, `LIN-DT-SPEC-F0T15PRE` | `LIN-DT-RUNBOOK-F2T1-SMOKE`, `LIN-DT-RUNBOOK-F2T1QUOTA` |
| `LIN-DT-RUNBOOK-F2T1-SMOKE` | `LIN-DT-MSCHED-001`, `LIN-DT-RUNBOOK-F2T1` | — |
| `LIN-DT-RUNBOOK-F2T1QUOTA` | `LIN-DT-MSCHED-001`, `LIN-DT-RUNBOOK-F2T1`, `LIN-DT-SIA-001` | — |
...
| `LIN-DT-SIA-001` | `LIN-DT-MSCHED-001`, `LIN-DT-SCHED-001` | `LIN-DT-RUNBOOK-F2T1`, `LIN-DT-RUNBOOK-F2T1QUOTA` |
| `LIN-DT-SPEC-F0T15POST` | `LIN-DT-DOSSIER-001`, `LIN-DT-SPEC-F0T2a`, `LIN-DT-SPEC-F0T4a`, `LIN-DT-SPEC-F0T15PRE`, `LIN-DT-AUGAUDIT-001` | — |
| `LIN-DT-SPEC-F0T15PRE` | `LIN-DT-DOSSIER-001`, `LIN-DT-SPEC-F0T2a`, `LIN-DT-SPEC-F0T5`, `LIN-DT-MSCHED-001` | `LIN-DT-AUGAUDIT-001`, `LIN-DT-RUNBOOK-F2T1`, `LIN-DT-SPEC-F0T15POST` |
| `LIN-DT-SPEC-F0T17` | `LIN-DT-ENGSTD-001`, `LIN-DT-DOSSIER-001`, `LIN-DT-SPEC-F0T2a`, `LIN-DT-SPEC-F0T4a` | — |
| `LIN-DT-SPEC-F0T2a` | `LIN-DT-SPEC-F0T4a`, `LIN-DT-DOSSIER-001`, `LIN-DT-CHKLST-001` | `LIN-DT-AUGAUDIT-001`, `LIN-DT-DOSSIER-001`, `LIN-DT-ENGSTD-001`, `LIN-DT-ROSTER-F0T1b`, `LIN-DT-SPEC-F0T15POST`, `LIN-DT-SPEC-F0T15PRE`, `LIN-DT-SPEC-F0T17`, `LIN-DT-SPEC-F0T4a`, `LIN-DT-SPEC-F0T5`, `LIN-DT-SPEC-F0T8`, `LIN-DT-TESTDOC-001` |
| `LIN-DT-SPEC-F0T4C` | `LIN-DT-SPEC-F0T4A`, `LIN-DT-SPEC-F0T2A`, `LIN-DT-RND-T1DIAGA-001` | `LIN-DT-SPEC-F0T4D` |
| `LIN-DT-SPEC-F0T4D` | `LIN-DT-SPEC-F0T4A`, `LIN-DT-SPEC-F0T4C`, `LIN-DT-DOSSIER-001`, `LIN-DT-RPTBP-001` | — |
| `LIN-DT-SPEC-F0T4a` | `LIN-DT-SPEC-F0T2a`, `LIN-DT-DOSSIER-001`, `LIN-DT-CHKLST-001` | `LIN-DT-AUGAUDIT-001`, `LIN-DT-CHRONOS-001`, `LIN-DT-DOSSIER-001`, `LIN-DT-ENGSTD-001`, `LIN-DT-SPEC-F0T15POST`, `LIN-DT-SPEC-F0T17`, `LIN-DT-SPEC-F0T2a`, `LIN-DT-SPEC-F0T8` |
| `LIN-DT-SPEC-F0T5` | `LIN-DT-SPEC-F0T2a`, `LIN-DT-DOSSIER-001`, `LIN-DT-MSCHED-001` | `LIN-DT-SPEC-F0T15PRE` |
| `LIN-DT-SPEC-F0T8` | `LIN-DT-DOSSIER-001`, `LIN-DT-SPEC-F0T2a`, `LIN-DT-SPEC-F0T4a`, `LIN-DT-CHKLST-001`, `LIN-DT-ENGSTD-001` | — |
...
- `docs/gates/F0-T20b_FRANKEN_CAPACITY_AB_2026-05-31.md`
- `docs/gates/F0-T20c_MEL_FRONTEND_AB_2026-06-01.md`
- `docs/gates/F0-T20d_SCALING_CURVE_2026-06-01.md`
- `docs/gates/F0-T21_A2_FRAME_RATE_BREAKTHROUGH_2026-06-02.md`
...
- `docs/gates/PIPELINE_AUDIT_F2T1_READINESS_2026-05-30.md`
- `docs/gates/R&D_Tier1_reports/T1-C/T1C_REPORT.md`
- `docs/gates/R&D_Tier1_reports/T1-DIAG-A/T1_DIAG_A_REPORT.md`
- `docs/gates/R&D_Tier1_reports/T1-E/T1E_REPORT.md`
- `docs/gates/R&D_Tier1_reports/T1-F/T1F_REPORT.md`
- `docs/gates/R&D_Tier1_reports/T1-G/T1G_REPORT.md`
- `docs/gates/R&D_Tier1_reports/T1-H/T1H_REPORT.md`
- `docs/methodology/F0-T20_CROSS_KIT_AUGMENTATION_SPEC.md`
- `docs/methodology/F0-T21_GENERALIZATION_ROOT_CAUSE_SPEC.md`
